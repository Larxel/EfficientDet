...
def EfficientNetB0(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.0, 1.0, 256, 0.2,
...
def EfficientNetB1(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.0, 1.1, 256, 0.2,
...
def EfficientNetB2(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.1, 1.2, 256, 0.3,
...
def EfficientNetB3(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.2, 1.4, 256, 0.3,
...
def EfficientNetB4(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.4, 1.8, 256, 0.4,
...
def EfficientNetB5(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.6, 2.2, 256, 0.4,
...
def EfficientNetB6(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.8, 2.6, 256, 0.5,
...
def EfficientNetB7(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(2.0, 3.1, 256, 0.5,
